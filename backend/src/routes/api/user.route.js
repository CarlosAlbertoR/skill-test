...
router.post(
  "/emailverify",
  validateEmail,
  awaitHandlerFactory(userController.verifyEmail)
);
router.post(
  "/signup",
  createUserSchema,
  awaitHandlerFactory(userController.userSignup)
);
router.post(
  "/login",
  validateLogin,
...
router.get(
  "/:sortby/:page/:limit",
  auth(Role.Super),
  awaitHandlerFactory(userController.getUsers)
);
router.get(
  "/id/:id",
  auth(Role.Super),
...
router.patch(
  ...
  auth(),
  updatePasswordSchema,
  awaitHandlerFactory(userController.updatePassword)
);
router.delete(
  "/id/:id",
  auth(Role.Super),
...
router.patch(
  ...
  updatePasswordSchema,
  auth(),
  awaitHandlerFactory(userController.resetPassword)
);
